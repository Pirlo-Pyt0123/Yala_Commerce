...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      {/* Mobile top bar */}
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-zinc-900 border-b border-zinc-800 px-4 h-14 flex items-center justify-between">
        <Link href="/" className="text-white font-bold text-base">Licorería Admin</Link>
        ...
        <div className="md:hidden fixed inset-0 z-50 flex">
          <div className="w-60 bg-zinc-900 border-r border-zinc-800 flex flex-col">
            ...
            <div className="p-4 border-t border-zinc-800">
              <button onClick={logout} className="text-zinc-500 hover:text-red-400 text-xs">
                Cerrar sesión
              </button>
            </div>
          </div>
